...
Final interactive Dashboard (Movies vs TV Shows comparison)

JioHotstar Dataset.csv - Dataset of JioHotstar content
...
Distribution of genres across both categories.

Trend of content releases over recent years.

Most frequent age ratings on the platform.

Average running time for movies (TV shows excluded).
...
(Dashboard created for learning and visualization purposes.)
